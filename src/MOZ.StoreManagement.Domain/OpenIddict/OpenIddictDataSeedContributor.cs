...
namespace MOZ.StoreManagement.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("StoreManagement") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "StoreManagement", DisplayName = "StoreManagement API", Resources = { "StoreManagement" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["StoreManagement_App:RootUrl"]?.TrimEnd('/');
